...
tokenizer = AutoTokenizer.from_pretrained("UMCU/MedRoBERTa_SAP")
model = AutoModel.from_pretrained("UMCU/MedRoBERTa_SAP").cuda()
...
from sap_src.model_wrapper import (
    Model_Wrapper
)
from sap_src.metric_learning import (
    Sap_Metric_Learning,
)
