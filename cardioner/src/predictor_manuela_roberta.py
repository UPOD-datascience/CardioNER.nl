...
from transformers import (BertConfig, BertTokenizer, RobertaConfig, RobertaTokenizer, AutoTokenizer)
...
class Ner(XLMRobertaForTokenClassification):
...
def main():
    ...
    ## Required parameters
    parser.add_argument("--bert_model", default='bert_models/xlm-ner-slavic', type=str,
    ...
    model_dir = 'czech_medication/checkpoint_9'
    label_list = ["O", "B-MEDICATION", "I-MEDICATION", "[CLS]", "[SEP]"]
    label = "MEDICATION"
    path_list = ['../data/CardioCCC_Dataset/Testing/Czech/txt']
    output_file = 'czech_medication/inf_results_on_cz_testset_medication.tsv'
